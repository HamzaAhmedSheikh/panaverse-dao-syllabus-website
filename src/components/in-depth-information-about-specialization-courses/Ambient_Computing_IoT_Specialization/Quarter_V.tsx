...
const Quarter_V_IoT = () => {
  return (
    <>
     ...
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> What is the Fourth Industrial Revolution? </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> What is IoT? </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> Embedded Systems </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> Hardware and Software for IoT </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> Edge and Cloud Computing </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> The future of IoT is AI </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> Blockchain in the Internet of Things? </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> IoT + AI + Blockchain: The Fourth Industrial Revolution has begu </Text>
     <Text as='p' mt='0.5em' mb='0.3em' color='#606C71'> How will Matter change the IoT Infrastructure and address issues Metaverse and IoT  </Text>

     <Text as='p' mt='0.6em' color='#606C71'> Mid-Term I: Introduction to the Internet of Things (IoT) Quiz in Week 3 </Text>
     <Text as='p' mt='0.6em' color='#606C71'> Total Questions: 46, Total Time: 60 minutes </Text>
     ...
     <Text as='p' mt='0.8em' fontWeight='semibold' color='#606C71'>  Introduction to C Part 1 (Weeks 3B, 4, and 5) </Text>
     ...
     <List as='ul' styleType='disc' className={styles.list}>
      ...
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Data types and sizes  </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Constants  </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Arithmetic operations  </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Logical and relational operators  </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Type conversion </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Bitwise operators  </Text>
      </ListItem>
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Conditional expressions  </Text>
      </ListItem>
     </List> 
     
     <Text as='p' mt='0.5em' color='#606C71' fontWeight='semibold'> Programming Assignments will also be given. </Text>
 
     <Text as='p' mt='0.7em' color='#606C71' fontWeight='semibold'>  C Programming Part 2 (Weeks 6 and 7) </Text>
     ...
     <List as='ul' styleType='disc' className={styles.list}>
      ...
      <ListItem> 
        <Text as='p' mt='0.4em' color='#606C71' fontWeight='semibold'> Function and Program structure(Returning and non-returning, scope rules, Recursion)  </Text>
      </ListItem>
     </List>
     ...
     <Text as='p' mt='0.7em' color='#606C71' fontWeight='semibold'>  Introduction to Embedded systems Part 1 (Weeks 8) </Text>
     <Text as='p' mt='0.7em' color='#606C71' fontWeight='semibold'> Basic Electronics and Introduction to microcontrollers <br /> Chapter 1 of  “Internet of things with ESP8266”  </Text>
      ...
      <List as='ul' styleType='disc' className={styles.list}>
        ...
        <ListItem> 
          <Text as='p' mt='0.5em' color='#606C71' fontWeight='semibold'> Burning your first code on ESP8266  </Text>
        </ListItem>
      </List>
     ...
     <Text as='p' mt='0.7em' color='#606C71' fontWeight='semibold'> Mid-Term II: C Programming Quiz 1 in Week 9 </Text>
     <Text as='p' mt='0.7em'  color='#606C71' fontWeight='semibold'> Total Questions: 62, Total Time: 75 minutes </Text>
     
    
    
     <Text as='p' mt='0.7em' color='#606C71' fontWeight='semibold'>  Introduction to Embedded systems Part 2 (Weeks 9-12) </Text>
     <Text as='p' mt='0.6em' color='#606C71' fontWeight='semibold'> Chapters 2-5 of  “Internet of things with ESP8266”  </Text>
      ...
      <List as='ul' styleType='disc' className={styles.list}>
        ...
        <ListItem> <Text as='p' mt='0.6em' color='#606C71' fontWeight='semibold'> Controlling LEDs </Text> </ListItem>
        <ListItem>
