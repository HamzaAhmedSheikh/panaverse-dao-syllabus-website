...
const Section_I = () => {
  return (
    <>
      <Heading id='web-3-and-metaverse-specialization' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
        Web 3 and Metaverse Specialization
      </Heading>
      <Heading id='quarter-iv-web3-and-metaverse' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
        Quarter IV Web3 and Metaverse
      </Heading>
      <Heading id='w3-351-developing-smart-contracts-and-planet-scale-web-30-dapps' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
      ...
      <Text as='p' mt='0.8em' color='#606C71'>
        ...
        and create user interfaces for them. We will also learn to develop
        ERC-20 and NFT tokens, DAOs, Oracles, etc. Please note that in order to
        develop Web 3 applications you also need to build on top of Web 2.0
        technologies which we have already covered in the previous quarters.
      </Text>
      ...
      <Heading id='blockchain-and-metaverse-theory' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
      ...
      <Heading id='smart-contract-development-in-solidity' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
      ...
      <Text as='p' mt='0.8em' color='#1e6bb8' bgColor='transparent' fontWeight='normal' _hover={{ cursor: 'pointer', textDecoration: 'underline' }}>
       ...
       <Heading id='dapp-development-using-ethersjs-and-nextjs-13' as='h3' fontSize='1.5em' mt='1rem' mb='1rem' fontWeight='normal' color='#159957'>        
