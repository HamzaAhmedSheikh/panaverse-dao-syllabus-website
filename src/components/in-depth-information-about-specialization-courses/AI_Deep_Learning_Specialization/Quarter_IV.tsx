...
import Quarter_V from "./Quarter_V";
  ...
  return (
    <>
      <Heading
        ...
        color="#159957"
      >        
        Quarter IV Artificial Intelligence (AI) and Deep Learning Specialization
      </Heading>
      ...
      <Text as="p" mt="0.8em" color="#606C71">
        ...
        Learning Specialization is a foundational program that will aid in your
      ...
      <Text as="p" mt="0.7em" color="#606C71">        
        Python Crash Course, 2nd Edition: A Hands-On, Project-Based Introduction
        to Programming 2nd Edition
      </Text>
