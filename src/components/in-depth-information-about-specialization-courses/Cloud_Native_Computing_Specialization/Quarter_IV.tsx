  ...
  return (
    <>
      ...
      <Text as='p' mt='0.6em' color='#606C71'>
       Cloud-native architecture and technologies are an approach to designing, constructing,
       and operating workloads that are built in the cloud and take full advantage of the cloud
       computing model. Cloud-native technologies empower organizations to build and run
      ...
      <Text as='p' mt='0.6em' color='#606C71'> 
       ...
       In this course, you will learn how to develop cloud applications using
...
export default CNCCS_Quarter_IV